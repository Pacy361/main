        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="#"><i class="fa fa-dashboard "></i>监控</a>
                    </li>
                    <li>
                        <a href="/toWeb" ><i class="fa fa-desktop "></i>网页空间</a>
                         
                    </li>
                     <li>
                        <a href="/toSql"><i class="fa fa-yelp "></i>数据库</a>
                         
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-bicycle "></i>提交工单</a>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line"></h1></h1>
