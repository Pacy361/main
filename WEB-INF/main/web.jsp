	...
	<body>
		<div class="content">
			<div id="register_box">
				...
				<div id="main_box">
					<form class="register" action="Web" method="post">
						<h1>选择运行环境</h1>
						<br />
						<table>
						<tr>
						...
						<td>
						<div class="text">
							<font>java</font><input type="radio" name="1" id="1"  value="" onclick="return text3();"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<font>php</font><input type="radio" name="1" id="2"  value="" onclick="return text4();"/><br />
						</div>	
						</td>
						<td>
						<br/>
